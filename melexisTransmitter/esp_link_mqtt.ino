...
//    mqtt.publish("/melexis/TEMP", buf);
//
//    //itoa(backDoorState, buf, 10);
//    mqtt.publish("/melexis/BACK", buf);
//
//    //itoa(mudroomDoorState, buf, 10);
//    mqtt.publish("/melexis/MUDROOM", buf);
//
//    //itoa(pirState, buf, 10);
//    mqtt.publish("/melexis/PIR", buf);
//
//    timeoutOne = now;
//  }
}
